    ...
    func testExternalBundleNoticeEscalatesToBoundaryUpgradeWhenMarketplaceReplacementExists() {
        let notice = PluginManager.externalBundleNotice(
            ...
            registryPlugin: RegistryPlugin(
                ...
                categories: ["utility"],
                size: 1,
                downloadURL: "https://github.com/Kombuchameister/my-whisper-fork/releases/download/test/replacement.zip",
                iconSystemName: nil,
                requiresAPIKey: nil,
                hosting: nil,
                descriptions: nil,
...
final class PluginRegistryDestinationTests: XCTestCase {
    ...
    private func makeRegistryPlugin(id: String) -> RegistryPlugin {
        RegistryPlugin(
            ...
            categories: ["transcription"],
            size: 1,
            downloadURL: "https://github.com/Kombuchameister/my-whisper-fork/releases/download/test/Qwen3Plugin.zip",
            iconSystemName: "cpu",
